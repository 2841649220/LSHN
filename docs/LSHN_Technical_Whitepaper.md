...
> **版本**: v0.1.1 　|　**作者**: Apocalypse 　|　**GitHub**: [LSHN](https://github.com/2841649220/LSHN)
>
> **实现状态说明**: 本白皮书为理论设计文档; 与 `lshn/` 实现的偏差与修复记录见 [fix_plan_260806.md](fix_plan_260806.md) 与 [api_reference.md](api_reference.md) §7(已知限制)。
